...
return [
    ...
    */
    ...
    'items' => [
        ...
        [
            'label' => 'Permohonan Sertifikat Masjid',
        ...
        [
            'label' => 'Sertifikat Majlis Taklim',
        ...
        [
            ...
            'route' => 'backsite.islamic-art-institution.index',
            'icon' =>
        ...
        [
            'label' => 'Rekomendasi Santri Belajar ke Luar Negeri',
