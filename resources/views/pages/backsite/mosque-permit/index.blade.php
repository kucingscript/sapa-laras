                ...
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4 mb-8">
                    <div>
                        <h2 class="text-2xl md:text-3xl font-bold text-gray-800 dark:text-gray-200">
                            Permohonan Sertifikat Masjid/Musholla
                        </h2>
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                            Kelola data persyaratan untuk permohonan sertifikat masjid dan musholla.
                        </p>
                    </div>

                    <div>
                        @if ($data->isNotEmpty())
                            <a href={{ route('backsite.mosque-permit.edit', $data->first()->id) }}
