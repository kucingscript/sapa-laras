            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4 mb-8">
                <div>
                    <h2 class="text-2xl md:text-3xl font-bold text-gray-800 dark:text-gray-200">
                        Permohonan Izin Operasional Madin
                    </h2>
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        Kelola data persyaratan untuk permohonan izin operasioanl madin (Lembaga Diniyah Takmiliyah).
                    </p>
                </div>

                <div>
                    @if ($data->isNotEmpty())
                        <a href={{ route('backsite.madin-operational-permit.edit', $data->first()->id) }}
                    ...
                    <div class="grid sm:grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="flex flex-col bg-white shadow-md rounded-xl dark:bg-slate-900">
                            ...
                            <div class="p-4 md:p-5 space-y-4">
                                <div>
                                    <ol class="list-decimal list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1">
                                        @foreach ($d->supporting_data as $item)
                                            <li>{{ $item }}</li>
                                        @endforeach
                                    </ol>
                                </div>
