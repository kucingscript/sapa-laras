@extends('layouts.app')
@section('title', 'Rekomendasi Izin Belajar Ke Luar Negeri')
                ...
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4 mb-8">
                    <div>
                        <h2 class="text-2xl md:text-3xl font-bold text-gray-800 dark:text-gray-200">
                            Rekomendasi Izin Belajar Ke Luar Negeri
                        </h2>
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                            Kelola data persyaratan untuk rekomendasi izin belajar ke luar negeri.
                        </p>
                    </div>

                    <div>
                        @if ($data->isNotEmpty())
                            <a href={{ route('backsite.santri-study-abroad.edit', $data->first()->id) }}
