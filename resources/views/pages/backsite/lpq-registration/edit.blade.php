    ...
    <div class="w-full lg:ps-64">
        <div class="p-4 sm:p-6 space-y-4 sm:space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 sm:p-8 mt-5 dark:bg-slate-900">
                ...
                <form action="{{ route('backsite.lpq-registration.update', $lpqRegistration->id) }}" method="POST">
                    @csrf
                    @method('PUT')

                    <div x-data="{ requirements: {{ json_encode(old('requirements', $lpqRegistration->data ?? [''])) }} }">
                    ...
                    <div class="mt-8 flex justify-end items-center space-x-4">
                        <a href="{{ route('backsite.lpq-registration.index') }}"
