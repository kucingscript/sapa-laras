...
@section('title', 'Izin Operasional Pesantren')
                    ...
                    <div class="mb-10 grid grid-cols-1 sm:grid-cols-2 gap-4 border rounded-lg p-4 bg-slate-50">
                        <div class="flex items-center">
                            ...
                            <div class="text-left">
                                ...
                                <p class="text-secondary font-bold text-lg">20 Hari Proses</p>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        @php
                            $procedures = [
                                ...
                                [
                                    'title' => 'Verifikator Pusat',
                                    'description' => 'Tim verifikator pusat melakukan penilaian kelayakan',
                                ],
                                [
