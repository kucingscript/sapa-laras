        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="p-6 sm:p-10">
                    <div class="mb-10 grid grid-cols-1 sm:grid-cols-2 gap-4 border rounded-lg p-4 bg-slate-50">
                        <div class="flex items-center">
                            ...
                            <div class="text-left">
                                ...
                                <p class="text-secondary font-bold text-lg">3 Hari Proses</p>
                            </div>
                        </div>
                    ...
                    <div class="mb-12" x-data="{ activeTab: 'wakif' }">
                        <h2 class="text-xl font-bold text-secondary mb-4">Dokumen Persyaratan</h2>
                        <div class="p-1 flex flex-wrap gap-1 bg-secondary/10 rounded-lg mb-6">
                            <button @click="activeTab = 'wakif'"
                                :class="{ 'bg-white text-secondary shadow': activeTab === 'wakif', 'text-gray-600 hover:bg-white/60 hover:text-secondary': activeTab !== 'wakif' }"
                                class="flex-1 py-2.5 text-sm font-medium leading-5 text-center rounded-md transition-colors duration-150 focus:outline-none">
                                Pihak Wakif
                            </button>
                            <button @click="activeTab = 'nazhir'"
                                :class="{ 'bg-white text-secondary shadow': activeTab === 'nazhir', 'text-gray-600 hover:bg-white/60 hover:text-secondary': activeTab !== 'nazhir' }"
                                class="flex-1 py-2.5 text-sm font-medium leading-5 text-center rounded-md transition-colors duration-150 focus:outline-none">
                                Pihak Nazhir
                            </button>
                            <button @click="activeTab = 'objek'"
                                :class="{ 'bg-white text-secondary shadow': activeTab === 'objek', 'text-gray-600 hover:bg-white/60 hover:text-secondary': activeTab !== 'objek' }"
                                class="flex-1 py-2.5 text-sm font-medium leading-5 text-center rounded-md transition-colors duration-150 focus:outline-none">
                                Objek Wakaf
                            </button>
                            <button @click="activeTab = 'saksi'"
                                :class="{ 'bg-white text-secondary shadow': activeTab === 'saksi', 'text-gray-600 hover:bg-white/60 hover:text-secondary': activeTab !== 'saksi' }"
                                class="flex-1 py-2.5 text-sm font-medium leading-5 text-center rounded-md transition-colors duration-150 focus:outline-none">
                                Saksi
                            </button>
                        </div>
                        ...
                        <div>
                            <div x-show="activeTab === 'wakif'" x-data="{ subTab: 'perseorangan' }">
                                <h3 class="text-lg font-bold text-gray-800 mb-4">Persyaratan Pihak Wakif (Pemberi)</h3>
                                <div class="flex flex-wrap gap-2 mb-4">
                                    <button @click="subTab = 'perseorangan'"
                                        :class="{ 'bg-secondary/10 text-secondary ring-2 ring-secondary/50': subTab === 'perseorangan', 'text-gray-500 hover:bg-gray-100': subTab !== 'perseorangan' }"
                                        class="px-3 py-1.5 font-medium text-xs rounded-md transition">Perseorangan</button>
                                    <button @click="subTab = 'organisasi'"
                                        :class="{ 'bg-secondary/10 text-secondary ring-2 ring-secondary/50': subTab === 'organisasi', 'text-gray-500 hover:bg-gray-100': subTab !== 'organisasi' }"
                                        class="px-3 py-1.5 font-medium text-xs rounded-md transition">Organisasi</button>
                                    <button @click="subTab = 'badan_hukum'"
                                        :class="{ 'bg-secondary/10 text-secondary ring-2 ring-secondary/50': subTab === 'badan_hukum', 'text-gray-500 hover:bg-gray-100': subTab !== 'badan_hukum' }"
                                        class="px-3 py-1.5 font-medium text-xs rounded-md transition">Badan Hukum</button>
                                </div>
                                    ...
                                    <ul class="space-y-3 text-gray-700 text-base">
                                        @forelse($waqf->wakif_perseorangan as $req)
                                            <li class="flex items-start"><svg
                                                    class="flex-shrink-0 w-5 h-5 text-secondary mt-1 mr-3"
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                    <polyline points="20 6 9 17 4 12" />
                                                </svg><span>{{ $req }}</span></li>
                                        @empty<p class="text-center text-gray-500">Persyaratan tidak tersedia.</p>
                                        @endforelse
                                    </ul>
                                </div>
                            ...
                            <div x-show="activeTab === 'nazhir'" style="display: none;" x-data="{ subTab: 'perseorangan' }">
                                <h3 class="text-lg font-bold text-gray-800 mb-4">Persyaratan Pihak Nazhir (Penerima)</h3>
                                <div class="flex flex-wrap gap-2 mb-4">
                                    <button @click="subTab = 'perseorangan'"
                                        :class="{ 'bg-secondary/10 text-secondary ring-2 ring-secondary/50': subTab === 'perseorangan', 'text-gray-500 hover:bg-gray-100': subTab !== 'perseorangan' }"
                                        class="px-3 py-1.5 font-medium text-xs rounded-md transition">Perseorangan</button>
                            ...
                            <div x-show="activeTab === 'objek'" style="display: none;">
                                <h3 class="text-lg font-bold text-gray-800 mb-4">Persyaratan Objek Wakaf (Tanah)</h3>
                                <ul class="space-y-3 text-gray-700 text-base">
                            ...
                            <div x-show="activeTab === 'saksi'" style="display: none;">
                                <h3 class="text-lg font-bold text-gray-800 mb-4">Persyaratan Saksi</h3>
                                <ul class="space-y-3 text-gray-700 text-base">
                    ...
                    <div>
                        ...
                        @php
                            $procedures = [
                                ...
                                [
                                    'title' => 'Pengisian Akta',
                                    'description' => 'Pemohon melakukan pengisian Akta Ikrar Wakaf dihadapan PPAIW',
                                ],
                                [
                                    'title' => 'Ikrar Wakaf',
                                    'description' => 'Melakukan ikrar wakaf oleh wakif Kepada nadzir',
                                ],
                                [
                                    'title' => 'Akta Ikrar Wakaf',
                                    'description' => 'PPAIW menerbitkan dan menandatangani Akta Ikrar Wakaf',
                                ],
                                [
                                ...
                                [
                                    ...
                                    'description' => 'BPN menerbitkan sertifikat atas nama nadzir',
                                ],
                                [
                                    'title' => 'Penyerahan Sertifikat',
                                    'description' => 'Sertifikat diserahkan kepada nadzir atau pemohon',
                                ],
                            ];
                        @endphp
                        <div
