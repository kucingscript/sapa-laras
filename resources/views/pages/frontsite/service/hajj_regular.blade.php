                        ...
                        @php
                            $procedures = [
                                [
                                    ...
                                    'description' => 'Pemohon membawa berkas permohonan yang disyaratkan',
                                ],
                                [
                                ...
                                [
                                    'title' => 'Entri Data',
                                    'description' => 'Petugas seksi melakukan entri data pada aplikasi SISKOHAT',
                                ],
                                ['title' => 'Pengambilan Foto', 'description' => 'Pemohon melakukan pengambilan foto'],
                                [
                                    'title' => 'Disposisi',
                                    'description' =>
                                ...
                                [
                                    'title' => 'Pencetakan Berkas',
                                    'description' => 'SPH dicetak rangkap 2 dan diberikan kepada petugas pelayanan',
                                ],
                                [
                                    'title' => 'Penyerahan SPH',
                                    'description' => 'Petugas Pelayanan memberikan SPH kepada pemohon',
                                ],
                            ];
                        @endphp
                        <div
