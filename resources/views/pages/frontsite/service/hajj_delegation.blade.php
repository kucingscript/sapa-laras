        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="p-6 sm:p-10">
                    ...
                    <div class="mb-12" x-data="{ activeTab: 'meninggal' }">
                        <div class="p-1 flex space-x-1 bg-secondary/10 rounded-lg mb-6">
                            <button @click="activeTab = 'meninggal'"
                                :class="{
                                    'bg-white text-secondary shadow': activeTab === 'meninggal',
                                    'text-gray-600 hover:bg-white/60 hover:text-secondary': activeTab !== 'meninggal'
                                }"
                            ...
                            <button @click="activeTab = 'sakit'"
                                :class="{
                                    'bg-white text-secondary shadow': activeTab === 'sakit',
                                    'text-gray-600 hover:bg-white/60 hover:text-secondary': activeTab !== 'sakit'
                                }"
                                class="w-full py-2.5 text-sm font-medium leading-5 text-center rounded-md transition-colors duration-150 focus:outline-none">
                                Sakit Permanen
                            </button>
                        ...
                        <div x-show="activeTab === 'meninggal'" style="display: none;">
                            <h3 class="text-xl font-bold text-secondary mb-4">Persyaratan Pelimpahan Karena Jamaah Wafat
                            </h3>
                        ...
                        <div x-show="activeTab === 'sakit'" style="display: none;">
                            <h3 class="text-xl font-bold text-secondary mb-4">Persyaratan Pelimpahan Karena Sakit Permanen
                            </h3>
                            <ul class="space-y-3 text-gray-700 text-base">
