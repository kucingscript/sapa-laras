            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="bg-gradient-to-br from-secondary to-secondaryhvr p-6 sm:p-8 text-center">
                    ...
                    <h1 class="text-2xl sm:text-3xl font-bold text-white">
                        Layanan Rekomendasi Santri Belajar ke Luar Negeri
                    </h1>
                        ...
                        @php
                            $procedures = [
                                [
                                    ...
                                    'description' => 'Pemohon layanan datang membawa berkas persyaratan',
                                ],
                                [
                                    'title' => 'Verifikasi Berkas',
                                    'description' =>
                                        'Petugas layanan menerima berkas dan melakukan pengecekan kelengkapan berkas',
                                ],
                                [
                                    'title' => 'Pengajuan Berkas',
                                    'description' => 'Petugas menyerahkan berkas lengkap ke petugas seksi',
                                ],
                                [
                                    'title' => 'Disposisi',
                                    'description' => 'Surat permohonan dilakukan disposisi oleh kepala seksi',
                                ],
                                [
                                    'title' => 'Entri Data',
                                    'description' => 'Petugas melakukan entri data pemohon layanan',
                                ],
                                ['title' => 'Pencetakan Surat', 'description' => 'Petugas mencetak surat rekomendasi'],
                                [
                                    'title' => 'Penyerahan Surat',
                                    'description' => 'Surat rekomendasi diberikan kepada pemohon layanan',
                                ],
                            ];
                        @endphp
                        <div
