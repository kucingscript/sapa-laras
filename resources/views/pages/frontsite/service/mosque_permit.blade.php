            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="bg-gradient-to-br from-secondary to-secondaryhvr p-6 sm:p-8 text-center">
                    ...
                    <h1 class="text-2xl sm:text-3xl font-bold text-white">
                        Layanan Permohonan Sertifikat Masjid / Musholla
                    </h1>
                            ...
                            @php
                                $procedures = [
                                    ...
                                    [
                                        ...
                                        'description' =>
                                            'Jika hasil verifikasi dinyatakan layak, ID/sertifikat masjid/musholla diterbitkan',
                                    ],
                                    [
                                        'title' => 'Disposisi',
                                        'description' => 'ID/sertifikat masjid/mushola didisposisi oleh kepala seksi',
                                    ],
                                    [
                                        'title' => 'Penyerahan Sertifikat',
                                        'description' => 'Sertifikat masjid/mushola diserahkan kepada pemohon',
                                    ],
                                ];
                            @endphp
