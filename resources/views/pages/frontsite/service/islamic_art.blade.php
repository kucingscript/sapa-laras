            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="bg-gradient-to-br from-secondary to-secondaryhvr p-6 sm:p-8 text-center">
                    ...
                    <h1 class="text-2xl sm:text-3xl font-bold text-white">
                        Layanan Sertifikat Lembaga Kesenian Islam
                    </h1>
                        ...
                        @php
                            $procedures = [
                                ...
                                [
                                    ...
                                    'description' =>
                                        'Jika hasil verifikasi dinyatakan layak, sertifikat lembaga kesenian islam diterbitkan',
                                ],
                                [
                                    'title' => 'Disposisi',
                                    'description' => 'Sertifikat lembaga kesenian islam didisposisi oleh kepala seksi',
                                ],
                                [
                                    'title' => 'Penyerahan Sertifikat',
                                    'description' => 'Sertifikat lembaga kesenian islam diserahkan kepada pemohon',
                                ],
                            ];
                        @endphp
                        <div
