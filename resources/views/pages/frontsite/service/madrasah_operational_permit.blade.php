                    ...
                    <div class="mb-10 grid grid-cols-1 sm:grid-cols-2 gap-4 border rounded-lg p-4 bg-slate-50">
                        <div class="flex items-center">
                            ...
                            <div class="text-left">
                                ...
                                <p class="text-secondary font-bold text-lg">14 Hari Proses</p>
                            </div>
                        </div>
                        ...
                        @php
                            $procedures = [
                                ...
                                [
                                    ...
                                    'description' =>
                                        'Pemohon mengunggah dokumen yang disyaratkan pada aplikasi <a class="font-medium text-secondary hover:underline" href="https://ijopmadrasah.kemenag.go.id/kabko" target="_blank" rel="noopener noreferrer">ijopmadrasah.kemenag.go.id/kabko</a>',
                                ],
                                [
                                    'title' => 'Verifikasi Dokumen',
                                    'description' =>
                                        'Tim verifikator Seksi melakukan verifikasi dokumen melalui <a class="font-medium text-secondary hover:underline" href="https://ijopmadrasah.kemenag.go.id/kabko" target="_blank" rel="noopener noreferrer">ijopmadrasah.kemenag.go.id/kabko</a>',
                                ],
                                [
                                ...
                                [
                                    ...
                                    'description' => 'Sertifikat rekomendasi diserahkan kepada pemohon',
                                ],
                            ];
                        @endphp
                        <div
