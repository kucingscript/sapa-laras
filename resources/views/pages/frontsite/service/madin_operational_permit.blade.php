...
@section('title', 'Izin Operasional Madin')
                ...
                <div class="p-6 sm:p-10">
                    <div class="mb-10 grid grid-cols-1 sm:grid-cols-2 gap-4 border rounded-lg p-4 bg-slate-50">
                        <div class="flex items-center">
                            ...
                            <div class="text-left">
                                ...
                                <p class="text-secondary font-bold text-lg">7 Hari Proses</p>
                            </div>
                        </div>
                    ...
                    <div class="mb-12" x-data="{ activeTab: 'persyaratan' }">
                        <div class="p-1 flex space-x-1 bg-secondary/10 rounded-lg mb-6">
                            ...
                            <button @click="activeTab = 'pendukung'"
                                :class="{
                                    'bg-white text-secondary shadow': activeTab === 'pendukung',
                                    'text-gray-600 hover:bg-white/60 hover:text-secondary': activeTab !== 'pendukung'
                                }"
                                class="w-full py-2.5 text-sm font-medium leading-5 text-center rounded-md transition-colors duration-150 focus:outline-none">
                                Dokumen Pendukung
                            </button>
                        ...
                        <div x-show="activeTab === 'pendukung'" style="display: none;">
                            <h3 class="text-xl font-bold text-secondary mb-4">Dokumen Pendukung</h3>
                            <ul class="space-y-3 text-gray-700 text-base">
                                @forelse ($madin->supporting_data as $sp)
                                    <li class="flex items-start">
                                        <svg class="flex-shrink-0 w-5 h-5 text-secondary mt-1 mr-3"
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        ...
                        @php
                            $procedures = [
                                [
                                    ...
                                    'description' =>
                                        'Pemohon layanan melakukan pendaftaran dan log in ke aplikasi <a class="font-medium text-secondary hover:underline" href="https://sitren.kemenag.go.id" target="_blank" rel="noopener noreferrer">sitren.kemenag.go.id</a>',
                                ],
                                [
                                ...
                                [
                                    'title' => 'Verifikator Kanwil',
                                    'description' => 'Tim verifikator Kanwil melakukan penilaian kelayakan',
                                ],
                                [
                                ...
                                [
                                    ...
                                    'description' => 'Surat rekomendasi dan izin operasional diserahkan kepada pemohon',
                                ],
                            ];
                        @endphp
                        <div
