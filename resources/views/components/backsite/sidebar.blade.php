         ...
         <div
             ...
             <nav class="hs-accordion-group p-3 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
                 <ul class="flex flex-col space-y-1">
                     <li>
                         @php($isActive = request()->routeIs('backsite.dashboard.*'))
                ...
                {{ $isActive ? 'bg-gray-100 text-gray-800 dark:bg-neutral-700' : 'text-gray-800 hover:bg-gray-100 dark:hover:bg-neutral-700' }}"
                     ...
                     @php($isParentActive = request()->routeIs('backsite.permissions.*') || request()->routeIs('backsite.roles.*'))
                     @canany(['permission_access', 'role_access'])
                         <li class="hs-accordion {{ $isParentActive ? 'active' : '' }}" id="account-accordion">
                             <button type="button"
                                 class="hs-accordion-toggle w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 text-sm rounded-lg focus:outline-none dark:text-neutral-200
                   {{ $isParentActive ? 'bg-gray-100 text-gray-800 dark:bg-neutral-700' : 'text-gray-800 hover:bg-gray-100 dark:hover:bg-neutral-700' }}">
                             ...
                             <div id="account-accordion-child"
                                 ...
                                 <ul class="ps-8 pt-1 space-y-1">
                                     @can('permission_access')
                                         <li>
                                             @php($isActive = request()->routeIs('backsite.permissions.*'))
                                             <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm rounded-lg hover:bg-gray-100 focus:outline-none dark:hover:bg-neutral-700
                {{ $isActive ? 'text-blue-600 dark:text-blue-400' : 'text-gray-800 dark:text-neutral-200' }}"
                                                 href="{{ route('backsite.permissions.index') }}">
                                                 ...
                                                 <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg"
                                                     ...
                                                     <path d="M4 14.5l3.5-3.5h1.5l7 7" />
                                                     <path d="M12.5 19.5L14 21l-1.5 1.5" />
                                                 </svg>
                                                 Permission
                                             </a>
                                         </li>
                                     ...
                                     @can('role_access')
                                         <li>
                                             @php($isActive = request()->routeIs('backsite.roles.*'))
                                             <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm rounded-lg hover:bg-gray-100 focus:outline-none dark:hover:bg-neutral-700
                {{ $isActive ? 'text-blue-600 dark:text-blue-400' : 'text-gray-800 dark:text-neutral-200' }}"
                                                 href="{{ route('backsite.roles.index') }}">
                     ...
                     @can('user_access')
                         <li>
                             @php($isActive = request()->routeIs('backsite.users.*'))
                             <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm rounded-lg focus:outline-none dark:text-white
                {{ $isActive ? 'bg-gray-100 text-gray-800 dark:bg-neutral-700' : 'text-gray-800 hover:bg-gray-100 dark:hover:bg-neutral-700' }}"
                                 href="{{ route('backsite.users.index') }}">
                                 <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24"
                                     height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                     stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                     ...
                     @can('program_access')
                         <li>
                             @php($isActive = request()->routeIs('backsite.programs.*'))
                             <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm rounded-lg focus:outline-none dark:text-white
                {{ $isActive ? 'bg-gray-100 text-gray-800 dark:bg-neutral-700' : 'text-gray-800 hover:bg-gray-100 dark:hover:bg-neutral-700' }}"
                                 href="{{ route('backsite.programs.index') }}">
                                 <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24"
                                     height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                     stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                     ...
                     @can('content_access')
                         <li>
                             @php($isActive = request()->routeIs('backsite.contents.*'))
                             <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm rounded-lg focus:outline-none dark:text-white
                {{ $isActive ? 'bg-gray-100 text-gray-800 dark:bg-neutral-700' : 'text-gray-800 hover:bg-gray-100 dark:hover:bg-neutral-700' }}"
                                 href="{{ route('backsite.contents.index') }}">
                                 <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24"
                                     height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                     stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                     ...
                     <li>
                         <form method="POST" action="{{ route('logout') }}">
                             ...
                             <button type="submit"
                                 class="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none dark:hover:bg-neutral-700 dark:text-neutral-200">
                                 <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24"
                                     height="24" viewBox="0 0 24" fill="none" stroke="currentColor"
                                     stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
