<section id="contact" class="max-w-[85rem] px-4 sm:px-6 lg:px-8 pb-8 mx-auto">
    <div class="relative p-6 md:p-12 bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <div class="hidden md:block absolute top-0 end-0 size-36">
            <div
                class="absolute top-8 right-[-40px] transform rotate-45 w-48 h-10 bg-secondary flex items-center justify-center">
        ...
        <div class="absolute top-0 end-0 -z-10 size-80 bg-primary/20 rounded-full blur-3xl opacity-50">
        </div>
        <div class="absolute bottom-0 start-0 -z-10 size-80 bg-secondary/10 rounded-full blur-3xl opacity-50">
        </div>

        <div class="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div>
                <h2 class="text-2xl md:text-4xl font-bold text-secondary text-left">
                ...
                <div class="mt-6 sm:mt-8">
                    <a class="py-3 px-5 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg bg-secondary text-white hover:bg-secondaryhvr transition-colors"
